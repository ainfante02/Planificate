...
class Usuario_1 extends InTouch_Test_Controller {
    ...
    function index() {
        ...
        $this->pagination->initialize(
            array(
                'base_url'    => base_url() . "usuario/index" . $usuario_id,
      ...
      $this->load->view('structure/header_usuario', 
        ...
        $this->load->view('usuario_1/index.php', $data);
...
/*--------------------------------------------------------------*/
    ...
    public function edit()
    {
       ...
       header('location: ' . base_url() . 'usuario/' . $this->request->requerimiento_id);
            die;

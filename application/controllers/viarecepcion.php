...
class Viarecepcion extends CI_Controller {
	...
	public function index()
	{
		...
		redirect('viarecepcion/promociones');
	...
	public function promociones()
	{
		try{
			...
			$crud->set_table('viarecepcion');
			
			/* Nombre de referencia a la tabla */
			$crud->set_subject('viarecepcion');
		...
		$crud->columns(
			...
			/* La mandamos a la vista alermas/application/view/admin/promociones.php */
			 $this->load->view('structure/header', 
	                 ...
	                 $this->load->view('parametros/viarecepcion', $output);

...
class Erequerimiento extends CI_Controller {
	...
	public function index()
	{
		...
		redirect('erequerimiento/promociones');
	...
	public function promociones()
	{
		try{
			...
			$crud->set_table('estadorequerimiento');
			
			/* Nombre de referencia a la tabla */
			$crud->set_subject('estadorequerimiento');
		...
		$crud->columns(
			...
			/* La mandamos a la vista alermas/application/view/admin/promociones.php */
			 $this->load->view('structure/header', 
	                 ...
	                 $this->load->view('parametros/erequerimiento', $output);

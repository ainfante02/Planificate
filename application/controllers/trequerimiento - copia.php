...
class Trequerimiento extends CI_Controller {
	...
	public function index()
	{
		...
		redirect('trequerimiento/promociones');
	...
	public function promociones()
	{
		try{
			...
			$crud->set_table('tiporequerimiento');
			
			/* Nombre de referencia a la tabla */
			$crud->set_subject('tiporequerimiento');
		...
		$crud->columns(
			...
			/* La mandamos a la vista alermas/application/view/admin/promociones.php */
			 $this->load->view('structure/header', 
	                 ...
	                 $this->load->view('parametros/trequerimiento', $output);

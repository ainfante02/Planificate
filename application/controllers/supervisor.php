...
class Supervisor extends InTouch_Test_Controller {
   ...
   public function promociones()
	{
        ...
        $this->pagination->initialize(
            array(
                'base_url'    => base_url() . "projects/promociones" . $usuario_id,
...
file_put_contents('salida.txt', $datos);*/
		...
		/* Y la fecha de vencimiento es mayor a la fecha estimada */

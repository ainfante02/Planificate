...
class Requerimiento_edit extends CI_Controller {
	...
	public function index()
	{
		...
		redirect('requerimiento_edit/promociones');
	...
	public function promociones()
	{
		try{
			...
			$crud->set_table('requerimiento');
			
			/* Nombre de referencia a la tabla */
			$crud->set_subject('requerimiento');
  ...
  'usuario_id'
			...
			/* La mandamos a la vista alermas/application/view/admin/promociones.php */
			 $this->load->view('structure/header', 
	                 ...
	                 $this->load->view('parametros/requerimiento', $output);

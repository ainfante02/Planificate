...
class Pdf_auditorias extends CI_Controller {

	function __construct()
	{
		parent::__construct();
   $this->load->model('auditoria_model', 'model');
    $this->load->model('auditinti_model', 'auditinti_model');
...
/*         $this->load->model('project_model', 'model'); */
	...
	{
		redirect('pdf_auditorias/descargar');
...
$data['query']=$this->auditinti_model->auditoria();
       ...
       $html = $this->load->view('actividades/v_dpdf_auditorias',$data,true);

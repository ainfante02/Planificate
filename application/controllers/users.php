...
class Users extends InTouch_Test_Controller {
   ...
   $this->load->model('auditoria_model', 'auditoria_model');
    ...
    {   
        ...
        $this->auditoria_model->save3( $this->request->post(), $aid );
    ...
    public function edit()
    {
        ...
        if( $this->request->request_method == 'POST' ){
            ...
            if( ! $this->model->validate ( $this->request->post(), 'update' ) ) {
              ...
              $this->model->save( $this->request->post(), TRUE );
     /*     $this->user_model2->save2( $this->request->post(), $aid );*/
        $this->auditoria_model->save( $this->request->post());
        /* $this->model->save( $this->request->post() );
           $this->auditoria_model->save3( $this->request->post());*/
       /*   $this->user_model2->save2( $this->request->post() );*/

        
             header('location: ' . base_url() . 'users/' . $this->request->usuario_id);
               header('location: ' . base_url() . 'users/');
            die;

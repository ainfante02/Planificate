...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript">
            ...
            function saltar(id){
                $("#editar").load("http://proyecto/planificate/index.php/datos/mostrar_datos", { id: id }); 
                $("#editar").fadeIn('2000');
            }
        </script>
    </head>
    ...
    <body>
        <table>
            ...
            foreach ($mensajes as $fila):
                ...
                <tr>
                    <td><?= $fila->descripcionrequerimiento ?></td>
                    <td><?= $fila->viarecepcion ?></td>
                    <td><?= $fila->prioridad ?></td>
                    <td><?= $fila->tiporequerimiento ?></td>

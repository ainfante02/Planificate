<?php
    ...
    $_formData = array(
      ...
      "prioridad" => '',
       ...
       "mensaje_actividad" => '',
        "fecha" => '',
          "accion" => 'Creacion de nuevo Requerimiento',
           "usuario_id" => ''
    );
   ...
   elseif( $user->rol ==0){
    ...
    if( isset( $data ) ) {
        ...
        if( isset ( $_formData['requerimiento_id'] ) ) {
            $action = 'edit/' . $_formData['requerimiento_id'];
            $title = 'Editar';
...
<div class="container">
                        ...
                        <?php 
                            ...
                            if ( isset ( $this->usuario ) ) {
                                foreach( $this->usuario AS $userObj ) {
									...
									if ($user->rol!=1){ 
										if($userObj->usuario_id != $_formData['usuario_id']){
											continue;
										}
									}
                                    ?>
  ...
  <?php
                    ...
                    <?php 
                        // Mostrar el error si hubo
                        if( isset( $errors['actividad_id'] ) ) {
                            foreach( $errors['actividad_id'] AS $info ) : ?>
                                <span class="help-block"><?php echo $info ?></span>
                            <?php endforeach;
                        } 
                    ?>
...
<div class="form-group <?php if( isset( $errors['viarecepcion'] ) ) echo 'has-error' ?>">
   ...
   <div class="form-group <?php if( isset( $errors['mensaje_actividad'] ) ) echo 'has-error' ?>">
                    ...
                    <label for="inp_name">Mensaje Alarma:</label>

...
<div class="container">
   ...
   <form action="<?php echo base_url()?>index.php/pausadas" method="POST">
...
<table class="table">
		...
		<?php   if ($row->estadorequerimiento==2 ){
...
?>
 ...
 <h1>   <a  class="btn btn-info" href="<?php echo base_url()?>pdf_pausadas">Exportar actividades a Pdf</a></h1>

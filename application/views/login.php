...
<html lang="en">
    ...
    <head>
       ...
       <!-- <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Roboto:400,100,300,500">-->
         <link rel="stylesheet" href="<?php echo ("http://fonts.googleapis.com/css?family=Roboto:400,100,300,500"); ?>" />
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                             <!--<h1><strong>MERCAL</strong>PARA AYUDAR A MEDIR</h1>--> 
                            <div class="description">
                    <!--        	<h3>
	                            	Sistema de control de Gestion <!--<a href="http://www.mercal.gob.ve"><strong>MERCAL</strong></a> Lo que no se mide no se Mejora
                            	</h3>-->
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Bienvenidos a Planificate</h3>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 social-login">
                        	...
                        	<div class="social-login-buttons">
	                        	<a class="btn btn-link-1 btn-link-1-facebook" href="https://www.facebook.com/MsionMercal"target="_blank">
	                        		<i class="fa fa-facebook"></i> Facebook
	                        	</a>
	                        	<a class="btn btn-link-1 btn-link-1-twitter"href="https://twitter.com/mercaloficial"target="_blank">
	                        		<i class="fa fa-twitter"></i> Twitter
	                        	</a>
	                        	<a class="btn btn-link-1 btn-link-1-google-plus"href="http://www.mercal.gob.ve"target="_blank">
	                        		<i class=" fa-google-plus"></i> Pagina Web
	                        	</a>
                        	</div>
                        </div>
                    </div>
